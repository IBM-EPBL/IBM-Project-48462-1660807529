...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Prem\Documents\sem7\IBMproject\ibmbackend\waterapp'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Prem\Documents\sem7\IBMproject\ibmbackend\waterapp\Scripts\deactivate.nu'
